...
export default {
  ...
  methods: {
    shan (index) {
      ...
      params.append('id', i)
      this.axios.post('api/shanp', params).then(res => {
    ...
    xiu () {
      ...
      params.append('id', id)
      this.axios.post(`api/xiup`, params).then(res => {
        document.getElementById('hidebg').style.display = 'none'
        document.getElementById('hidebox').style.display = 'none'
        location.reload()
      })
    ...
    yes () {
      ...
      this.axios.post(`api/addp`, params).then(res => {
        document.getElementById('hidebg').style.display = 'none'
        document.getElementById('hidebox').style.display = 'none'
        location.reload()
      })
  ...
  mounted () {
    this.axios.get('api/pu').then(res => {
      console.log(res)
      this.test = res.data
      console.log(res.data)
    })
